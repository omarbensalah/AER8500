...
class Interface:
        ...
        with open('/tmp/calculatorToInterface') as fifo:
            while True:
                ...
                if (len(dataTab[0]) == 10): #A429
                    ...
                    self.enginePower = decodeA429(dataTab[2], "cal")["enginePower"]
                    ...
                    self.enginePower = decodeAfdx(dataTab[2], "cal")["enginePower"]
                    self.avionicsUnit = temp["avionicsUnit"]
    ...
    def submit(self):
        ...
        A429 = "{},{},{}".format(encodeA429("agr", 1, "", altitude_num), encodeA429("agr", 2, "", enginePower_num), encodeA429("agr", 3, "", verticalSpeed_num))
        Afdx = "{},{},{}".format(encodeAfdx("agr", 1, "", altitude_num), encodeAfdx("agr", 2, "", enginePower_num), encodeAfdx("agr", 3, "", verticalSpeed_num))
